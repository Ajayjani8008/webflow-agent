...
- End-to-end inline: render-first intake → native-module build → pixel-verify (converge to zero visual diffs, ≥97% pixel score) → responsive-pass. MCP always over REST.
