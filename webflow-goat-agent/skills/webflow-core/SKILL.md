...
shipping the toy version of an under-specified brief · substituting a reference's content when the user asked for a replica · offering the user a choice whose every option abandons the reference · asking the user to spec what you can infer ·
