...
Command: `/figma-setup <figma-url>` → saves to `$WF/sites/<site-id>/figma-cache/` (per site since v1.9.0; `WF="$HOME/docs/memory/webflow"`). Different URL for one-off task → don't cache, work directly.
